...
public enum JsonType {
	...
	static final JsonType[][] EXCLUDING_ARRAYS = {{NUMBER, BOOLEAN, NULL, ARRAY, OBJECT}, {STRING, BOOLEAN, NULL, ARRAY, OBJECT}, {STRING, NUMBER, NULL, ARRAY, OBJECT}, {STRING, NUMBER, BOOLEAN, ARRAY, OBJECT}, {STRING, NUMBER, BOOLEAN, NULL, OBJECT}, {STRING, NUMBER, BOOLEAN, NULL, ARRAY}};
	...
	/**
	 * Returns an array of all JSON types excluding the given type. If the given
	 * type is null (Java null), this method returns {@link #values()}.
	 *
	...
	/**
	 * Returns an array of all {@linkplain #isPrimitive() primitive types}. This
	 * array contains {@link #STRING}, {@link #NUMBER} and {@link #BOOLEAN}, in
	 * that order.
	 *
	...
	/**
	 * Returns an array of all {@linkplain #isConstruct() construct types}. This
	 * array contains {@link #ARRAY} and {@link #OBJECT}, in that order.
	 *
	...
	/**
	 * Returns an array of all not-{@linkplain #isPrimitive() primitive} types.
	 * This array contains {@link #NULL}, {@link #ARRAY} and {@link #OBJECT}, in
	 * that order.
	 *
	...
	/**
	 * Returns an array of all not-{@linkplain #isConstruct() construct} types.
	 * This array contains {@link #STRING}, {@link #NUMBER}, {@link #BOOLEAN}
	 * and {@link #NULL}, in that order.
	 *
	 * @return An array of all not-primitive types.
	 */
	...
	/**
	 * Returns whether this JSON type is a primitive type. Primitive types are,
	 * with the exception of the null type, all types that represent one value.
	 * This are {@linkplain #STRING strings}, {@linkplain #NUMBER numbers} and
	...
	/**
	 * Returns whether this JSON type is a construct type. Construct types are,
	 * all types that are constructed of zero or more value. This are
	 * {@linkplain #OBJECT objects} and {@linkplain #ARRAY arrays}.
	 *
	...
	/**
	 * Returns whether this JSON type is {@linkplain #NULL null}. This is
	 * equivalent of comparing to {@link #NULL} directly:
	 * {@code type == JsonType.NULL}.
	 *
